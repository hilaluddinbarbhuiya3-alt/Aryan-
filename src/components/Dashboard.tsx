                ...
                <div className="w-full p-6">
                  ...
                  <form onSubmit={onSubmit} className="relative w-full max-w-[600px] mx-auto">
                    ...
                    <textarea
                      ...
                      rows={1}
                      className="w-full pl-6 pr-12 py-4 rounded-[28px] text-lg font-medium focus:outline-none transition-all resize-none overflow-hidden block leading-relaxed relative z-10 placeholder-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.12)]"
                      style={{
                        color: "#98203e",
                        backgroundColor: "#9a1434",
